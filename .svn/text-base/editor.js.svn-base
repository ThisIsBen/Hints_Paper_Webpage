...
//  ['strikethrough','subscript','superscript','separator'],
    ...
    ['HorizontalRule','uploadfile','Createlink','InsertImage','InsertMedia','InsertTable','htmlmode','separator'],
    //['HorizontalRule','uploadfile','Createlink','InsertImage','InsertTable','htmlmode','separator'],
...
this.btnList = {
    ...
    "uploadfile":     ['UploadFile',           'Upload File',        'editor_action(this.id)',  'G3-right1.ico'],
    ...
    "insertmedia":    ['InsertMedia',          'Insert Media',       'editor_action(this.id)',  'ed_image.gif'],
...
function editor_action(button_id) {
  ...
  else if (cmdID == 'UploadFile') {
//	showModelessDialog("/AuthoringTool/Upload/UploadImage.aspx", "", "resizable: no; help: no; status: no; scroll: no; dialogHeight:400px; dialogWidth:700px");
	//window.open("/AuthoringTool/Upload/UploadImage.aspx", "Upload", "resizable: no; help: no; status: no; scroll: no; Height:400px; Width:700px");
	
	// modified @ 2006-07-06 by dolphin
	alert();
	window.open("/Hints/AuthoringTool/CaseEditor/ItemAnimation/EditIA_FileMetadata.aspx?Action=New", "_blank", "resizable=yes,status=yes,scrollbars=yes,height=600px,width=800px");
  }
...
//      editdoc.execCommand(cmdID,1);
	  myRange = editdoc.selection.createRange();
	  if(myRange.text != "")
		showModalDialog(_editor_url + "popups/insert_hyperlink.html", editdoc, "resizable: no; help: no; status: no; scroll: yes; dialogWidth: 650px; dialogHeight: 170px");
	  else
    ...
    {
      //showModalDialog(_editor_url + "UploadMediaFile.aspx", editdoc, "resizable: no; help: no; status: no; scroll: no; ");
      window.open("UploadMediaFile.aspx","","width=800px,height=150px");
    }
